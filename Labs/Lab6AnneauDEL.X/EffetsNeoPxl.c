...
void NeoWave(void)
{
   ...
   if (couleur < 100)
   {
        g_NeoGreen[NEO_NUM - 1] = (uint8_t) couleur; 
        g_NeoBlue[NEO_NUM - 1] = (uint8_t) 0;
        g_NeoRed[NEO_NUM - 1] = (uint8_t) 0;
   }
   else if (couleur < 200)
   {
        g_NeoGreen[NEO_NUM - 1] = (uint8_t) 0; 
        g_NeoBlue[NEO_NUM - 1] = (uint8_t) couleur % 100;
        g_NeoRed[NEO_NUM - 1] = (uint8_t) 0;
   }
   ...
   else if (couleur < 300)
   {
        g_NeoGreen[NEO_NUM - 1] = (uint8_t) 0; 
        g_NeoBlue[NEO_NUM - 1] = (uint8_t) 0;
        g_NeoRed[NEO_NUM - 1] = (uint8_t) couleur % 200;
   }
