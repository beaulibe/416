 ...
 * @date   10 fév. 2020
 * @brief  Programme démo de la semaine 4 du cours 247-416. ADC
 */
...
void initialisation(void)
{
    ...
    */
    ...
    ADCON2bits.ADFM = 0; //Alignement à gauche des 10 bits de la conversion (8 MSB dans ADRESH et 2 LSB à gauche dans ADRESL)
