 ...
 *         Utilise le mode Compare du CCP2 pour modifier la 
  * broche CCP2(RC1) lorsque la valeur du timer 1 = 0xAABB. 
  * On veut qu'à chacun des passages du timer 1 à 0xAABB la broche CCP2(RC1) change d'état.
...
void initialisation(void)
{
   ...
   // PIE1bits.TMR1IE = 1;
    ...
    //intr de CCP2
   // PIR2bits.CCP2IF = 0;
    PIE2bits.CCP2IE = 0; //interruptions non permises
